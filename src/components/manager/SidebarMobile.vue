  ...
  sm:hidden focus:outline-none">
    ...
    <div class="overflow-auto max-h-40">
      <div @click="onClickBoard(index)" v-for="(board, index) in boardsStore.boards" :key="index"
        class="flex items-center gap-4 px-6 py-2 cursor-pointer text-medium-grey font-bold   "
    ...
    <div @click="createNewBoard()"
      class=" flex items-center gap-4 px-6 py-2 cursor-pointer font-bold fill-main-blue text-main-blue hover:bg-medium-grey/10">
      <IconBoard />
