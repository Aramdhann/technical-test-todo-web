  ...
  <main>
    <div class="flex w-full">
      ...
      <div v-dragscroll:nochilddrag
        class="relative h-full w-screen min-h-[calc(100vh-64px)] bg-light-grey dark:bg-very-dark-grey"
        :class="managerStore.sidebar ? 'sm:pl-[256px] lg:pl-[300px]' : ''">
        <div data-dragscroll class="p-6 w-full overflow-auto min-h-[calc(100vh-64px)] transition-all">
